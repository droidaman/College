...
if($_REQUEST[delete]=="1")
{
	...
	$conn->Execute($sql);
	$sql="DELETE FROM members_visits WHERE VID='".mysql_real_escape_string($DUSERID)."'";
	$conn->Execute($sql);
	$sql="DELETE FROM posts_comments WHERE USERID='".mysql_real_escape_string($DUSERID)."'";
	$conn->Execute($sql);
	$sql="DELETE FROM posts_favorited WHERE USERID='".mysql_real_escape_string($DUSERID)."'";
	$conn->Execute($sql);
