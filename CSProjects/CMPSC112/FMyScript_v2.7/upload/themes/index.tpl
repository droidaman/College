	<div id="wrapper">
        ...
        <div class="post">
            <p style="text-align:center; font-size:12px">
            	<b>{$lang196}:</b> {if $s eq "a" OR $s eq ""}{$lang197}{else}<a href="{$baseurl}/">{$lang197}</a>{/if} | {if $s eq "t"}{$lang198}{else}<a href="{$baseurl}/?s=t">{$lang198}</a>{/if} | {if $s eq "w"}{$lang199}{else}<a href="{$baseurl}/?s=w">{$lang199}</a>{/if} | {if $s eq "m"}{$lang200}{else}<a href="{$baseurl}/?s=m">{$lang200}</a>{/if} | {if $s eq "y"}{$lang201}{else}<a href="{$baseurl}/?s=y">{$lang201}</a>{/if}
            </p>
        </div>
