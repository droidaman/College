        ...
        <div class="header">
            ...
            <div class="nav-bar">
            	<ul id="nav">
                    ...
                    <li onmouseover="Element.addClassName(this,'over')" onmouseout="Element.removeClassName(this,'over')" class="{if $mainmenu eq "4"}active{/if}   parent level0"> <a href="#"  onclick="return false" class=""><span>Stories</span></a>
                    	<ul >
                            <li  class="   level1"> <a href="stories_manage.php"   class=""><span>Manage Stories</span></a></li>
                            <li  class="   level1"> <a href="stories_validate.php"   class=""><span>Validate Stories</span></a></li>
                            <li  class="   last level1"> <a href="stories_reported.php"   class=""><span>Reported Stories</span></a></li>
                        </ul>
                    </li>
                    ...
                    <li onmouseover="Element.addClassName(this,'over')" onmouseout="Element.removeClassName(this,'over')" class="{if $mainmenu eq "9"}active{/if}   parent level0"> <a href="#"  onclick="return false" class=""><span>Comments</span></a>
                    	<ul >
                            <li  class="   level1"> <a href="comments.php"   class=""><span>Manage Comments</span></a></li>
                            <li  class="   last level1"> <a href="comments_reported.php"   class=""><span>Reported Comments</span></a></li>
                        </ul>
                    </li>
