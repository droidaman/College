                                                ...
                                                <tbody>
                                                    ...
                                                    <tr class="hidden">
                                                        ...
                                                        <td class="value">
                                                            ...
                                                            <option value="1" {if $member.gender eq 1}selected{/if}>Male</option>
                                                            <option value="0" {if $member.gender eq 0}selected{/if}>Female</option>
                                                            </select>
                                                        </td>
                                                    ...
                                                    <tr class="hidden">
                                                        ...
                                                        <td class="value">
                                                        	<input id="city" name="city" value="{$member.city|stripslashes}" class=" required-entry required-entry input-text" type="text"/>
                                                        </td>
                                                        <td class="scope-label">[MEMBER CITY]</td>
                                                            <td><small></small></td>
                                                    </tr>
                                                    <tr class="hidden">
                                                        <td class="label"><label for="name">Country </label></td>
                                                        <td class="value">
                                                        	<input id="country" name="country" value="{$member.country|stripslashes}" class=" required-entry required-entry input-text" type="text"/>
                                                        </td>
                                                        <td class="scope-label">[MEMBER COUNTRY]</td>
                                                            <td><small></small></td>
                                                    </tr>
                                                    <tr class="hidden">
                                                        <td class="label"><label for="name">Story Views </label></td>
                                                        <td class="value">
                                                        	<input id="yourviewed" name="yourviewed" value="{$member.yourviewed}" class=" required-entry required-entry input-text" type="text"/>
                                                        </td>
                                                        <td class="scope-label">[NUMBER OF VIEWS OF STORIES THE MEMBER OWNS]</td>
                                                            <td><small></small></td>
                                                    </tr>
                                                    <tr class="hidden">
                                                        <td class="label"><label for="name">Stories Viewed </label></td>
                                                        <td class="value">
                                                        	<input id="youviewed" name="youviewed" value="{$member.youviewed}" class=" required-entry required-entry input-text" type="text"/>
                                                        </td>
                                                        <td class="scope-label">[NUMBER OF STORIES THE MEMBER VIEWED]</td>
                                                            <td><small></small></td>
                                                    </tr>
                                                    <tr class="hidden">
