            ...
            <div id="page:main-container">
				<div class="columns ">
                                ...
                                <div id="isoft_group_4_content" style="display:none;">
                                	<div class="entry-edit">
                                        <div class="entry-edit-head">
                                            <h4 class="icon-head head-edit-form fieldset-legend">Reported Stories</h4>
        			...
        			<div id="customerGrid">
        				...
        				<tr>
                    		<td class="pager">
                            	Showing {if $total gt 0}{$beginning} - {$ending} of {/if}{$total} Stories
                    		</td>
	    	    	    		...
	    	    	    		<tbody>
                                    ...
                                    <tr id="" >
                                        ...
                                        <td class=" last">
                                            ...
                                            <a href="stories_reported.php?page={$currentpage}&sortby={$sortby}&sorthow={$sorthow}{if $search eq "1"}&fromid={$fromid}&toid={$toid}&story={$story}&active={$active}{/if}&delete=1&PID={$results[i].PID}">Delete Story</a>&nbsp;|&nbsp;
					...
					<div class="main-col" id="content">
						<div class="main-col-inner">
                            ...
                            <div class="content-header">
                               <h3 class="icon-head head-products">Stories - Reported Stories</h3>
                            </div>
