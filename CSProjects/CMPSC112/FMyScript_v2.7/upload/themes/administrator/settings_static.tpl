                                            ...
                                            <div class="hor-scroll">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr class="hidden">
                                                        ...
                                                        <td class="value">
                                                            <textarea id="value" name="value" class=" textarea" type="textarea" style="width:700px; height:400px;" >{$static1.value|stripslashes}</textarea>
                                                        </td>
                                                    </tr>  
                                                    <tr class="hidden">
                                                        <td class="label">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr class="hidden">
                                                        ...
                                                        <td class="value">
                                                            <textarea id="value" name="value" class=" textarea" type="textarea" style="width:700px; height:400px;" >{$static2.value|stripslashes}</textarea>
                                                        </td>
                                                    </tr>  
                                                    <tr class="hidden">
                                                        <td class="label">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr class="hidden">
                                                        ...
                                                        <td class="value">
                                                            <textarea id="value" name="value" class=" textarea" type="textarea" style="width:700px; height:400px;" >{$static3.value|stripslashes}</textarea>
                                                        </td>
                                                    </tr>  
                                                    <tr class="hidden">
                                                        <td class="label">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr class="hidden">
                                                        ...
                                                        <td class="value">
                                                            <textarea id="value" name="value" class=" textarea" type="textarea" style="width:700px; height:400px;" >{$static4.value|stripslashes}</textarea>
                                                        </td>
                                                    </tr>  
                                                    <tr class="hidden">
                                                        <td class="label">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr class="hidden">
                                                        ...
                                                        <td class="value">
                                                            <textarea id="value" name="value" class=" textarea" type="textarea" style="width:700px; height:400px;" >{$static5.value|stripslashes}</textarea>
                                                        </td>
                                                    </tr>  
                                                    <tr class="hidden">
                                                        <td class="label">
