				...
				<div class="columns ">
					...
					<div class="side-col" id="page:left">
                        ...
                        <ul id="isoft" class="tabs">
    						...
    						<li >
        						<a href="comments_reported.php" id="isoft_group_2" name="group_2" title="Reported Comments" class="tab-item-link ">
                                    <span>
                                        <span class="changed" title=""></span>
                                        <span class="error" title=""></span>
                                        Reported Comments
                                ...
                                <div id="isoft_group_2_content" style="display:none;">
                                	<div class="entry-edit">
                                        <div class="entry-edit-head">
                                            <h4 class="icon-head head-edit-form fieldset-legend">Reported Comments</h4>
        			...
        			<div id="customerGrid">
        				...
        				<tr>
            				...
            				<td class="filter-actions a-right">
                            	<button  id="id_ffba3971e132ae3d78c160244ea09b39" type="button" class="scalable " onclick="document.location.href='comments_reported.php'" style=""><span>Reset Filter</span></button>
							...
							<div class="hor-scroll">
	    	    	    		...
	    	    	    		<tbody>
                                    ...
                                    <tr id="" >
                                        ...
                                        <td class=" ">{$results[i].story|stripslashes|truncate:80:"...":true}</td>
                                        ...
                                        <td class=" last">
                                        	<a href="comments_edit.php?CID={$results[i].CID}">Edit</a>&nbsp;|&nbsp;
                                        	<a href="comments_reported.php?page={$currentpage}&sortby={$sortby}&sorthow={$sorthow}{if $search eq "1"}&fromid={$fromid}&toid={$toid}&pid={$pid}&story={$story}&details={$details}&username={$username}{/if}&delete=1&CID={$results[i].CID}&PID={$results[i].PID}">Delete</a><br />
					...
					<div class="main-col" id="content">
						<div class="main-col-inner">
                            ...
                            <form action="comments_reported.php" method="post" id="main_form" name="main_form" enctype="multipart/form-data">
