							...
							<div class="hor-scroll">
	    	    	    		...
	    	    	    		<tbody>
                                    ...
                                    <tr id="" >
                                        ...
                                        <td class=" ">{$results[i].details|stripslashes|truncate:50:"...":true}</td>
                                        <td class=" ">{$results[i].time_added|date_format:"%b %e, %Y"}</td>
                                        <td class=" last">
                                        	<a href="comments_edit.php?CID={$results[i].CID}">Edit</a>&nbsp;|&nbsp;
                                        	<a href="comments.php?page={$currentpage}&sortby={$sortby}&sorthow={$sorthow}{if $search eq "1"}&fromid={$fromid}&toid={$toid}&pid={$pid}&story={$story}&details={$details}&username={$username}{/if}&delete=1&CID={$results[i].CID}&PID={$results[i].PID}">Delete</a>
                                        </td>
                                	</tr>
                                    {/section}
                                    <tr>
