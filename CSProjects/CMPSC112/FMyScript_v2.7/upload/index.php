...
$query2 = "SELECT * from posts A, categories B where A.active='1' $addsql2 AND A.category=B.CATID order by A.time_added desc limit $pagingstart, $config[items_per_page]";
...
if ($totalvideos > 0)
{
	...
	if ($currentpage > 0)
	{
		if($currentpage > 1) 
		{
			...
			$pagelinks.="...&nbsp;&nbsp;";
			$pagelinks.="<a href='$thebaseurl/?page=$theprevpage$adds'>&laquo; $lang[65]</a>&nbsp;&nbsp;";
		...
		{
			$pagelinks.="<a href='$thebaseurl/?page=$thenextpage$adds'>$lang[66] &raquo;</a>&nbsp;&nbsp;";
