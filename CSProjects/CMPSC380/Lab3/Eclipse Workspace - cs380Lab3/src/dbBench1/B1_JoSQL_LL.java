 ...
 * 			run time for.
 *
 * Use: java B1_JoSQL_LL file areaCodeOrName numRuns
 */
...
public class B1_JoSQL_LL {
	...
	public static void main(String[] args) {
		...
		B1_JoSQL_LL b1j = new B1_JoSQL_LL();
