// (c) 2011 Braden Licastro; FullForce Applications. All rights reserved.
//
...
#define L 64 // pot low
#define effect_select 1 // Choose the idle effect.
// MIN .5 minutes, MAX 8.0 minutes in .25 minute increments.
#define sleep_time 5 // Duration of time animation is allowed to run before device goes into power saving mode.
