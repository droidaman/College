...
public class LabClass
{
    ...
    //The classes alphabetical grade point average can be set. (usually A, B, C, D, F)
    private String gradeAverage;
    //The instructor can be rated numerically (Any scale can be used, usually 1-10 though.)
     ...
     */
    public LabClass(int maxNumberOfStudents, String averageGrade, int ratingOfTeacher)
    {
        instructor = "unknown";
        room = "unknown";
        timeAndDay = "unknown";
        ...
        //The average grade of the the class is currely unknown and is assigned a value accordingly.
        gradeAverage = averageGrade;
        //The professors rating will be set as a property in the header of the method.
        instructorRating = ratingOfTeacher;
    }
