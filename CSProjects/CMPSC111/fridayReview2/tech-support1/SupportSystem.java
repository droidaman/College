...
public class SupportSystem
{
    ...
    public void start()
    {
        ...
        while(!finished) {
            ...
            //Exercise 5.8: Trim the input of whitespace on its ends.
            input = input.trim();
            //Exercise 5.9: Convert the text to lowercase so it always matches (if its the same word).
            input = input.toLowerCase();

            //Exercise 5.11: Make sure the string equals "bye" but contains the word "bye".
            if(input.equals("bye")) {
                finished = true;
            }
            else {
