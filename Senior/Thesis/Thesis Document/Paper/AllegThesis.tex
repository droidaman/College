...
% ch:method
\include{ch03_methodofapproach} % Discussion of how the topic was implemented

%ch:implem
\include{ch04_resultsevaluation} % Chapter discussing the results and evaluations; inc threat to validity
...
\include{app}  % Appendices to be included here
