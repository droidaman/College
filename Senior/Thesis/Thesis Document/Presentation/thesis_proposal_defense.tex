...
\item Eliminating duplicates can save roughly \$18 million annually at current sharing levels\footnotemark
\end{itemize}
...
\frametitle{Website Details}
\begin{figure}
\includegraphics[width=3.75in]{schema}
...
\subsection{Calculation of Results} % A subsection can be created just before a set of slides with a common theme to further break down your presentation into chunks
...
\begin{frame}
\frametitle{Real-Time Statistics}
\begin{figure}
\includegraphics[width=.65\textwidth]{vitalstats}
\caption{Schema for File Uploads}
\end{figure}
\end{frame}
...
%------------------------------------------------
\section{Feasibility} % Sections can be created in order to organize your presentation into discrete blocks, all sections and subsections are automatically printed in the table of contents as an overview of the talk
%------------------------------------------------
...
\bibliography{thesis_proposal_defense}
\end{tiny}
\end{frame}
